                ...
                <div class="col-sm-4 col-md-3 col-xl-2">
                    <div class="footer-links fl-1">
                        ...
                        <ul class="foo-links clearfix">
                            ...
                            <li>
                                <p><NuxtLink to="/blog">About Us</NuxtLink></p>
                            </li>
                            <li>
                ...
                <div class="col-sm-4 col-md-3 col-xl-2">
                    <div class="footer-links fl-2">
                        ...
                        <ul class="foo-links clearfix">
                            ...
                            <li>
                                <p><NuxtLink to="/pricing">Pricing</NuxtLink></p>
                            </li>
                            <li>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="footer-links fl-4">
                        ...
                        <p class="footer-mail-link ico-25">
                            <a href="mailto:yourdomain@mail.com">admin@upplinko.com</a>
                        </p>
                        <!-- Social Links -->
                        <ul class="footer-socials ico-25 text-center clearfix">
                            <li>
                                <a href="https://www.facebook.com/upplinkoo/"><span class="flaticon-facebook"></span></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/upplinko/"><span class="flaticon-instagram"></span></a>
                            </li>
                            <li>
                                <a href="https://github.com/upplinko/nuxt-website"><span class="flaticon-github"></span></a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/company/upplinkoo/"><span class="flaticon-linkedin"></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
                    ...
                    <div class="col">
                        <div class="bottom-secondary-link ico-15 text-end">
                            <p class="p-sm">
                                <a href="https://themeforest.net/user/dsathemes/portfolio">Made with <span class="flaticon-heart color--pink-400"></span> by @upplinko</a>
                            </p>
                        </div>
                    </div>
                </div>
